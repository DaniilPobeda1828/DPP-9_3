...
2) Смешение логики и представления (логика настроек программы и логика гонки находяься в одном месте)
...
# Импорт библиотек
import turtle 
import random # Библиотек для работы со случайными значениями
...
t2 = None # Объект библиотеки Turtle (черепашка зелёного цвета)
win = False

# Функция базовой настройки окна
def setup():
    global sc, t1, t2
    sc = turtle.Screen()
    sc.setup(500,500)
